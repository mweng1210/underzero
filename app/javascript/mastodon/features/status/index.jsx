...
class Status extends ImmutablePureComponent {
  ...
  /* ══════════════════════════════════════════════════════════════════════════
   * @_longwhile custom feature / 한참(longwhile) 제작 기능 — 게시물 스크롤 오류 해결
  ...
  render() {
    ...
    const { isLoading, status, ancestorsIds, descendantsIds, intl, multiColumn, pictureInPicture } = this.props;
