...
class StatusesIndex < Chewy::Index
  ...
  index_scope ::Status.unscoped
                      .kept
                      .without_reblogs
                      .includes(:media_attachments, :local_mentioned, :local_favorited, :local_reblogged, :local_bookmarked, :tags, :quote, preview_cards_status: :preview_card, preloadable_poll: :local_voters),
  ...
  root date_detection: false do
    ...
    field(:text, type: 'text', analyzer: 'verbatim', search_analyzer: 'search_query', value: ->(status) { status.searchable_text }) do
      ...
      field(:personal, type: 'text', analyzer: 'personal_search', search_analyzer: 'search_query')
    end
    ...
    field(:is_favourited_by_current_user, type: 'boolean', value: ->(status) { 
      false 
    })
    field(:is_reblogged_by_current_user, type: 'boolean', value: ->(status) { false })
    field(:is_bookmarked_by_current_user, type: 'boolean', value: ->(status) { false })
  end
end